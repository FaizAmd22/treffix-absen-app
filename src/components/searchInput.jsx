...
const SearchInput = ({ placeholder, value, onChange, theme, openFilterPopup }) => {
    return (
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginBottom: "20px", marginTop: "20px" }}>
            <div style={{ width: "85%", display: "flex", color: "var(--bg-primary-color)", gap: "10px", alignItems: "center", border: theme === "light" ? "1px solid var(--border-primary-gray)" : "1px solid #363636", padding: "10px 15px", borderRadius: "8px" }}>
            ...
            <Button onClick={openFilterPopup}>
                <HiOutlineAdjustmentsHorizontal size={"24px"} color='var(--bg-primary-color)' />
            </Button>
        </div>
    )
}
