...
const FilterProcurementPopup = ({ isFilterPopup, closeFilterPopup, applyFilter, tempSelectedStatus, setTempSelectedStatus, tempSelectedType, setTempSelectedType, tempSelectedPeriod, setTempSelectedPeriod, toggleSelection, theme }) => {
            ...
            <Block style={{ height: "95%", padding: '15px', margin: 0, color: theme === "light" ? "black" : "white", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                <div>
                    ...
                    <div style={{ height: "69vh", overflowY: "auto" }}>
                        <p style={{ fontSize: "var(--font-md)", fontWeight: 700 }}>{translate('procurement_type_sub', language)}</p>
                        ...
                        <p style={{ fontSize: "var(--font-md)", fontWeight: 700, marginTop: "30px" }}>{translate('procurement_status_sub', language)}</p>
                        <div style={{ display: "flex", flexWrap: "wrap" }}>
                        ...
                        <div style={{ border: theme == "light" ? "1px solid var(--border-primary-gray)" : "1px solid #363636", borderRadius: "5px", marginTop: "20px", height: "45px" }}>
...
export default FilterProcurementPopup