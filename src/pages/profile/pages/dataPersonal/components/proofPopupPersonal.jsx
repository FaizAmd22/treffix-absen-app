...
const ProofPopupPersonal = ({
    ...
    return (
        <Popup
            ...
            style={{ top: '79%', borderRadius: '12px 12px 0 0', background: theme == "light" ? "var(--bg-primary-white)" : "var(--bg-secondary-black)" }}
        >
            <Block style={{ padding: 0, margin: 0, color: theme == "light" ? "black" : "white" }}>
                ...
                <List menuList style={{ margin: 0, padding: 0, fontSize: "var(--font-sm)" }}>
                    <ListItem>
                        <Button
                            style={{ textTransform: 'capitalize', color: theme == "light" ? "black" : "white" }}
                            onClick={() => {
                                onViewImage();
                                onClose();
                            }}
...
export default ProofPopupPersonal;