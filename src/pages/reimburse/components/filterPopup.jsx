            ...
            <Block style={{ height: "95%", padding: '15px', margin: 0, color: theme === "light" ? "black" : "white", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                <div>
                    ...
                    <div style={{ height: "69vh", overflowY: "auto" }}>
                        <p style={{ fontSize: "var(--font-md)", fontWeight: 700 }}>{translate('detail_reimburse_type', language)}</p>
                        <div style={{ display: "flex", flexWrap: "wrap" }}>
                            {gradeData.map((item, index) => (
                                <Button
                                    key={index}
                                    onClick={() => toggleSelection(item.name, tempSelectedType, setTempSelectedType)}
                                    style={{
                                        backgroundColor: tempSelectedType.includes(item.name) ? 'var(--bg-primary-green)' : theme == "light" ? '#E9E9E9' : "#212121",
                                        color: tempSelectedType.includes(item.name) ? 'white' : theme == "light" ? 'black' : "white",
                                        margin: '5px',
                                        padding: "4px 18px",
                                        borderRadius: "360px",
...
export default FilterReimbursePopup